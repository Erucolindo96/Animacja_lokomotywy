...
Cylinder::Cylinder(const GLfloat r, const GLfloat h, const std::string texture_path):Actor()
{
	const int CIRCLE_VERTS_COUNT = 20;
	countAndSetVertsAndIndices(r, h, CIRCLE_VERTS_COUNT);
